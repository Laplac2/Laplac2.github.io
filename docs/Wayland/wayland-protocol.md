...
- [2 合成器（Compositors）的类型](#2-合成器compositors的类型)
...
4. kmscon
5. rdp session
6. Weston with X11 or Wayland backend is a session compositor nested in another session compositor.
7. fullscreen X session under Wayland
